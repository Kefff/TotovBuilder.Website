...
import { ItemSortingService, compareByCategory, compareByName, compareByNumber, compareByString } from '../../../services/sorting/ItemSortingService'
...
describe('setSortingProperty()', () => {
  it.each([
    ...
    const sortService = new ItemSortingService()
