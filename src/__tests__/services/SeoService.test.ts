...
describe('SeoService', () => {
  describe('getBuildSeoDescription', () => {
    it('should get the description of a build formatted for SEO', async () => {
      ...
      // Assert
      expect(result).toBe('↕️ Vertical recoil 66   ↔️ Horizontal recoil 216   ✋ Ergonomics 34 (-9.5%)    🛡️ Armor class 4   🏃 Speed -6%   🔄 Turning speed -9%    💵 Price 366,019₽   ⚓ Weight 24.153 kg')
    })
  })
  ...
  describe('getBuildSeoMetadata', () => {
    it.each([
      ...
      expect(result).toStrictEqual({
        description: '↕️ Vertical recoil 66   ↔️ Horizontal recoil 216   ✋ Ergonomics 34 (-9.5%)    🛡️ Armor class 4   🏃 Speed -6%   🔄 Turning speed -9%    💵 Price 366,019₽   ⚓ Weight 24.153 kg',
