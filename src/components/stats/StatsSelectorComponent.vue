...
import EyewearStats from './eyewear/EyewearStatsComponent.vue'
import GrenadeStats from './grenade/GrenadeStatsComponent.vue'
import HeadwearStats from './headwear/HeadwearStatsComponent.vue'
import ItemStats from './item/ItemStatsComponent.vue'
import MagazineStats from './magazine/MagazineStatsComponent.vue'
import MeleeWeaponStats from './melee-weapon/MeleeWeaponStatsComponent.vue'
import ModStats from './mod/ModStatsComponent.vue'
import RangedWeaponModStats from './ranged-weapon-mod/RangedWeaponModStatsComponent.vue'
import RangedWeaponStats from './ranged-weapon/RangedWeaponStatsComponent.vue'
import VestStats from './vest/VestStatsComponent.vue'
