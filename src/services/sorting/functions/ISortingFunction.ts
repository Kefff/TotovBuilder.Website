 ...
 */
export interface ISortingFunction<T extends IBuildSummary | IItem> {
  /**
   * Comparison function.
   ...
   */
  comparisonFunction: (element1: T, element1Value: string | number, element2: T, element2Value: string | number) => number
